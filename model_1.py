...
class PatchRecovery(nn.Module):
    def __init__(self, patch_size, output_num, dim):
        ...
        # self.conv = nn.Conv2d(in_channels=dim*40, out_channels=37*4, kernel_size=(1,1), stride=(1,1))
...
class Mlp(nn.Module):
    def __init__(self, dim):
        ...
        self.linear1 = nn.Linear(in_features=dim, out_features=int(dim*2.5))
        self.linear2 = nn.Linear(in_features=int(dim*2.5), out_features=dim)
